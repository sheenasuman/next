...
const tools = [
  ...
  return (    
  <main className="bg-black text-white px-6 py-1">  
      ...
      <section>
               ...
               <div className=" max-w-4xl mx-auto text-center text-gray-300">
                      <p className="text-2xl text-[#BCB5BE]">Our powerful merge tool enables you to easily visualize changes, 
                        so you can untangle and resolve conflicts faster.</p>
                       <p className="mt-2 text-sm">Available in <span className="text-purple-400">GitKraken Desktop</span></p>
               </div>
      </section>
