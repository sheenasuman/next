...
export default function Header() {
  ...
  return (
    <header className="bg-[#0F0F0F] text-white px-8 py-4 relative z-50">
      <div className="flex items-center justify-between">
        {/* Logo */}
        <div className="flex items-center space-x-4">
          <Image src="/images/gitkraken.svg" alt="GitKraken" width={140} height={40} />
        </div>
        ...
        <nav className="flex items-center space-x-5 text-xl">
          ...
          >
            <button className="hover:text-[#9D4DFF]">Dev Tools ▾</button>
            {openMenu === 'devtools' && (
              <div className="absolute left-0 top-full mt-4 bg-[#1A1A1A] shadow-lg p-6 rounded-lg flex space-x-12 w-[1000px]">
                {/* Left Cards */}
                <div className="space-y-4 w-[280px]">
                  <div className="bg-[#151515] rounded-lg p-4 border border-gray-700 hover:border-[#9D4DFF]">
                    ...
                    <Link href="#" className="text-sm text-[#9D4DFF] mt-2 inline-block">
                      Supercharge Your Dev Team &gt;
                    </Link>
                  </div>

                  <div className="bg-[#151515] rounded-lg p-4 border border-gray-700 hover:border-[#9D4DFF]">
                    <h3 className="text-lg font-semibold">Enterprise Grade</h3>
                    <p className="text-sm text-gray-400 mt-1">
          ...
          >
            ...
            {openMenu === 'planning' && (
              <div className="absolute left-0 top-full mt-4 bg-[#151515] border border-gray-700 rounded-md shadow-xl p-6 w-[500px] flex space-x-8">
                {/* Products */}
                <div className="w-1/2">
